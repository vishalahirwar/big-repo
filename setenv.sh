...
JAVA_OPTS="$JAVA_OPTS -Denv.name=${WorkingEnvironment}"
JAVA_OPTS="$JAVA_OPTS -Dnavbar.url=${NavBarUrl}"
JAVA_OPTS="$JAVA_OPTS -Depay.client.id=${OIDC_EPAY_CLIENT_ID}"
JAVA_OPTS="$JAVA_OPTS -Depay.client.secret=${OIDC_EPAY_CLIENT_SECRET}"
JAVA_OPTS="$JAVA_OPTS -Djavax.net.ssl.trustStore=/usr/local/tomcat/truststore.jks"
JAVA_OPTS="$JAVA_OPTS -Djavax.net.ssl.trustStorePassword=${WDTS_TRUSTSTORE_PWD}"
JAVA_OPTS="$JAVA_OPTS -Dwdts-business-url=${WDTS_BUSINESS_URL}"
